...
public class LoginGenerator {
     ...
     * premiere lettre du prenom, concatenee avec les 3 premieres lettres du nom,
     * le tout mis en lettres capitales et desaccentue.
     * Le login genere doit etre unique par rapport a la liste des logins existants.
    ...
    public String generateLoginForNomAndPrenom(final String nom, final String prenom) {
        ...
        String n = deAccent(nom.substring(0,magicNumber3).toUpperCase());
        String login = p + n ;
